...
#
# Generated by export_simulation on Sat Nov 21 20:56:51 -0500 2020
#
################################################################################
...
'-reset_run' switch to the './sinewave_rcm_rom.sh' script.

./sinewave_rcm_rom.sh -reset_run
...
./sinewave_rcm_rom.sh -noclean_files

For more information on the script, please type './sinewave_rcm_rom.sh -help'.
