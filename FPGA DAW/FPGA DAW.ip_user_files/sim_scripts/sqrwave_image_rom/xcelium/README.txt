...
#
# Generated by export_simulation on Sat Nov 21 20:18:08 -0500 2020
#
################################################################################
...
'-reset_run' switch to the './sqrwave_image_rom.sh' script.

./sqrwave_image_rom.sh -reset_run
...
./sqrwave_image_rom.sh -noclean_files

For more information on the script, please type './sqrwave_image_rom.sh -help'.
