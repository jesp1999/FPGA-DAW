...
#
# Generated by export_simulation on Sun Dec 06 21:22:58 -0500 2020
#
################################################################################
...
'-reset_run' switch to the './track0_text_image_rom.sh' script.

./track0_text_image_rom.sh -reset_run
...
./track0_text_image_rom.sh -noclean_files

For more information on the script, please type './track0_text_image_rom.sh -help'.
