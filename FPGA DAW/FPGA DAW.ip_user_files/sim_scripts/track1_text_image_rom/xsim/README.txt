...
#
# Generated by export_simulation on Sun Dec 06 21:23:50 -0500 2020
#
################################################################################
...
'-reset_run' switch to the './track1_text_image_rom.sh' script.

./track1_text_image_rom.sh -reset_run
...
./track1_text_image_rom.sh -noclean_files

For more information on the script, please type './track1_text_image_rom.sh -help'.
