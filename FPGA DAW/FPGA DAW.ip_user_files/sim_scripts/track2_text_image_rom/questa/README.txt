...
#
# Generated by export_simulation on Sun Dec 06 21:24:36 -0500 2020
#
################################################################################
...
'-reset_run' switch to the './track2_text_image_rom.sh' script.

./track2_text_image_rom.sh -reset_run
...
./track2_text_image_rom.sh -noclean_files

For more information on the script, please type './track2_text_image_rom.sh -help'.
