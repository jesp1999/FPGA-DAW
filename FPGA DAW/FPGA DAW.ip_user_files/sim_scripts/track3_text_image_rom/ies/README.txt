...
#
# Generated by export_simulation on Sun Dec 06 21:25:22 -0500 2020
#
################################################################################
...
'-reset_run' switch to the './track3_text_image_rom.sh' script.

./track3_text_image_rom.sh -reset_run
...
./track3_text_image_rom.sh -noclean_files

For more information on the script, please type './track3_text_image_rom.sh -help'.
