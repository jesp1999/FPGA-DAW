...
HD_PWD='G:/My Drive/Coursework/MIT/Fall 2020/6.111/Final Project/FPGA DAW/FPGA DAW.runs/clk_wiz_65mhz_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_wiz_65mhz.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_wiz_65mhz.tcl
