...
HD_PWD='G:/My Drive/Coursework/MIT/Fall 2020/6.111/FPGA-DAW/FPGA DAW/FPGA DAW.runs/sinewave_image_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sinewave_image_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sinewave_image_rom.tcl
