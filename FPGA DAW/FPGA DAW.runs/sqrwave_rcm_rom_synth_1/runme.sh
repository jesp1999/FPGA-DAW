...
HD_PWD='G:/My Drive/Coursework/MIT/Fall 2020/6.111/FPGA-DAW/FPGA DAW/FPGA DAW.runs/sqrwave_rcm_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sqrwave_rcm_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sqrwave_rcm_rom.tcl
