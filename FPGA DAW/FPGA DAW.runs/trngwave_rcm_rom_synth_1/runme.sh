...
HD_PWD='C:/Users/natha/OneDrive/Desktop/MIT/F20/6.111/FPGA-DAW/FPGA DAW/FPGA DAW.runs/trngwave_rcm_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log trngwave_rcm_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source trngwave_rcm_rom.tcl
